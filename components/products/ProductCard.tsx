  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden bg-paper-soft">
        ...
        {product.badge && (
          <span className="absolute left-4 top-4 bg-paper/90 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wide text-ink backdrop-blur-sm">
            {product.badge}
          </span>
        )}
        ...
        <motion.button
          ...
          className="absolute inset-x-3 bottom-3 flex h-11 items-center justify-center gap-2 rounded-full bg-ink text-[12px] font-medium uppercase tracking-wide text-paper"
        >
